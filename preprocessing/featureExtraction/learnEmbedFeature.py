...
if __name__ == "__main__":
    ...
    """
    Default configuration: learn 300-dim embedding using SkipGram model with Negative Sampling techniques
    ...
    """
    model = Word2Vec(sentences, size=300, sg=1, hs=0, negative=12, window=5, min_count=5, workers=num_thread,
